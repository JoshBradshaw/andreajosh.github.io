...
The MIT Chapel is tucked away from the street to provide a peaceful setting. This means that it isn't all that easy to find. The exterior is fairly plain so its easy to miss. The links above pinpoint the exact location and include street view pictures. Consider arriving a bit early or having someone in your group scope out the chapel in advance to avoid a nerve wracking search.
