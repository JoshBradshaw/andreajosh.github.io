...
- MIT has some [public parking options](https://web.mit.edu/facilities/transportation/parking/visitors/public_parking.html). Hayward Garage is the closest visitor-friendly parking lot to the reception venue. This parking is expensive ($18 / hour).

- Other garages in Kendall Square offer better deals than MIT parking, but we don't have enough personal experience to make a recommendation. [SpotHero](https://spothero.com/) is a good resource.

- As a last resort, reach out to us if parking is an obstacle for your attendance. We've lived in this neighborhood for years, so we have some closely guarded secret solutions to parking issues.
